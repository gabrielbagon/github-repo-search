...
const LANGS = ["", "TypeScript", "JavaScript", "Python", "Java", "Go", "Rust"] as const;
  ...
  return (
    <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-4">
      ...
      <div className="flex-1 relative">
        <label htmlFor="search" className="sr-only">Buscar repositórios</label>
        <input
          id="search"
          type="search"
          value={query}
      ...
      <div className="flex items-center gap-2">
        <label htmlFor="language" className="text-sm text-neutral-400">Linguagem:</label>
        <select
          id="language"
          value={language}
      ...
      {/* (B) ORDENAR */}
      <div className="flex items-center gap-2">
        <label htmlFor="sort" className="text-sm text-neutral-400">Ordenar:</label>
        <select
          id="sort"
          value={sort}
      ...
      {sort !== "best" && (
        <div className="flex items-center gap-2">
          <label htmlFor="order" className="text-sm text-neutral-400">Ordem:</label>
          <select
            id="order"
            value={order}
      ...
      {/* (D) POR PÁGINA */}
      <div className="flex items-center gap-2">
        <label htmlFor="perPage" className="text-sm text-neutral-400">Por página:</label>
        <select
          id="perPage"
          value={perPage}
